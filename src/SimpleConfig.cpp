...
OptimizedRedisServer::Config SimpleConfig::load_from_file(const std::string& filename) {
...
OptimizedRedisServer::Config SimpleConfig::get_default_config() {
    OptimizedRedisServer::Config config;
...
int SimpleConfig::parse_int(const std::string& str, int default_val) {
    try {
        return std::stoi(str);
    } catch (...) {
        return default_val;
...
size_t SimpleConfig::parse_size_t(const std::string& str, size_t default_val) {
    try {
...
bool SimpleConfig::parse_bool(const std::string& str, bool default_val) {
